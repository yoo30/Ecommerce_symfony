...

{
...

    {
        ...
        return $this->render('ChoositPlatformBundle:Default:produits/layout/produits.html.twig', array('listProduits' => $listProduits));
...

    {
        ...
        return $this->render('ChoositPlatformBundle:Default:produits/layout/presentation.html.twig',
